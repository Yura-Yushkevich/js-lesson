...
function cards() {
  ...
  var el = document.querySelector('[target-menuCardWrp]').innerHTML = '';
  (0,_services_services__WEBPACK_IMPORTED_MODULE_3__.getResource)('http://localhost:3000/menu').then(function (data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
          ...
          descr = _ref.descr,
          price = _ref.price;
      new MenuCard(img, altimg, title, descr, price, '[target-menuCardWrp]').render();
    });
...
function fetchForm(formSelector, modalTimerId) {
  //FETCH
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.openModal)('.modal');
...
function slider(_ref) {
  ...
  function showCurrentNum(slideIndex) {
    if (slides.length < 10) {
      total.textContent = "0".concat(slides.length);
...
function tabs(tabsSelector, tabsContentSelector, tabsParantSelector, activeClass) {
  //Tabs ////////////////////////
  var tabContents = document.querySelectorAll(tabsContentSelector),
  ...
  hideTabContent();
  showTabContent();
  tabsParrent.addEventListener('click', function (e) {
    var target = e.target;
...
/* harmony import */ var _modules_fetchForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/fetchForm */ "./js/modules/fetchForm.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_fetchForm__WEBPACK_IMPORTED_MODULE_2__.default)('form', modalTimerId);
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_5__.default)('.tabheader__item', '.tabcontainer .tabcontent', '.tabheader__items', 'tabheader__item_active');
